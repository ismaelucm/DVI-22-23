...
otros=$(addprefix otros/, async.md canvas.md ejercicios_dom.md canvas_ex01.png canvas_ex02.png canvas_ex03.png exercise01.png exercise02.png exercise03_inspector_data_attr.png exercise03_inspector01.png exercise03_inspector02.png exercise03_querystring.png exercise03_selected_value.png exercise03_step02.png exercise03_strikethrough.png console.png buscar.png reportar.md entregar.md evaluacionproyectos.md grupos.md porcentajes.md)
