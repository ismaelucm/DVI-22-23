tema1=$(addprefix tema1/,evaluacion_proyectos.md introduccion.md logonode.svg tooling.md chrome.png vscode.png iterm.png firefox.png lenguajes_interpretados.md compilado.dot.svg instrucciones.dot.svg netscape_logo.svg interpretes.dot.svg no_copy.svg mozilla.png npm.png browserify.png phaser.png showcase.md evil_glitch.png godswillbewatching.png lotg.png dicey-dungeons.png slither-agar.png)
...
tema4=$(addprefix tema4/, mario_spritesheet.gif mariosprite.jpg mummy.gif introduccion_phaser.md groups_and_pooling.md input.md phaser_entities.md texto_en_phaser.md mostrar_rendering.png profiling.png pool.svg takepool.svg storepool.svg world.svg world-and-camera.svg guerrero.png phaser_coordinates.png)
...
tema10=$(addprefix tema10/, frameciclo.jpg tux_fondo.png tux.png animacion_con_sprites.md eventos_timer.md)
