tema1=$(addprefix tema1/,introduccion.md logonode.svg tooling.md chrome.png vscode.png iterm.png firefox.png lenguajes_interpretados.md compilado.dot.svg instrucciones.dot.svg netscape_logo.svg interpretes.dot.svg no_copy.svg mozilla.png npm.png browserify.png phaser.png showcase.md evil_glitch.png godswillbewatching.png lotg.png)
tema2=$(addprefix tema2/,creacion_paginas_web.md colgar_proyecto.md request_dance_step1.png request_dance_step2.png dom_section.png dom.md search.png ejemplo.html ejemplo.js ejemplo.css)
tema3=$(addprefix tema3/,javascript_modelo_ejecucion.md javascript_modelo_datos.md poo.md space-invaders-enemy-state.svg space-invaders-constructor-example.svg space-invaders-hierarchy.svg space-invaders-hierarchy-constructor.svg batman-storyboard.jpg lotr-notes.jpg mario-level-design.png monobehaviour-flowchart.png space-invaders.jpg space-invaders-objects.svg space-invaders-types.svg space-invaders-object-diagram.svg space-invaders-enemy-api.svg space-invaders-constructors.svg space-invaders-constructor-detail.svg ejercicios_js.md clases_es6.md modulos.md)
tema4=$(addprefix tema4/, mario_spritesheet.gif mariosprite.jpg mummy.gif carga_de_recursos_con_phaser.md groups_and_pooling.md input.md phaser_entities.md texto_en_phaser.md mostrar_rendering.png profiling.png pool.svg takepool.svg storepool.svg world.svg world-and-camera.svg guerrero.png)
...
basepandoc=pandoc -s --mathjax -M secPrefix= -M figPrefix= -M eqnPrefix= -M tblPrefix=  --filter pandoc-crossref $< -o $@
