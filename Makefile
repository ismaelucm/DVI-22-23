tema1=$(addprefix tema1/,evaluacion_proyectos.md introduccion.md logonode.svg tooling.md chrome.png vscode.png iterm.png firefox.png lenguajes_interpretados.md compilado.dot.svg instrucciones.dot.svg netscape_logo.svg interpretes.dot.svg no_copy.svg mozilla.png npm.png browserify.png phaser.png showcase.md evil_glitch.png godswillbewatching.png lotg.png dicey-dungeons.png)
