tema1=$(addprefix tema1/, evaluacion_proyectos.md introduccion.md logonode.svg tooling.md chrome.png vscode.png iterm.png firefox.png lenguajes_interpretados.md compilado.dot.svg compilar.dot.svg compilado-bytecode.dot.svg instrucciones.dot.svg netscape_logo.svg interpretes.dot.svg no_copy.svg mozilla.png npm.png browserify.png phaser.png showcase.md evil_glitch.png godswillbewatching.png lotg.png dicey-dungeons.png slither-agar.png tema-proyecto.md blasphemous.jpeg nazareno.jpg porteadores.jpg goya.jpg neptuno.jpg)
...
otros=$(addprefix otros/, async.md canvas.md ejercicios_dom.md canvas_ex01.png canvas_ex02.png canvas_ex03.png exercise01.png exercise02.png exercise03_inspector_data_attr.png exercise03_inspector01.png exercise03_inspector02.png exercise03_querystring.png exercise03_selected_value.png exercise03_step02.png exercise03_strikethrough.png console.png buscar.png reportar.md entregar.md evaluacionproyectos.md grupos.md porcentajes.md Ejercicio01.md github.md gh_crear_pr.jpg gh_pestanas_pr.jpg gh_validar_pr.jpg introduccion_disenio.md intro_videojuegos_001.png intro_videojuegos_002.png intro_videojuegos_003.png intro_videojuegos_004.png intro_videojuegos_005.png intro_videojuegos_006.png intro_videojuegos_007.png )
